  ...
  methods: {
    ...
    getRules(){
      if(this.pd.MXLX=="LZ_HC"){
        ...
        this.$api.post(this.Global.aport4+'/warningSortRuleController/selectByMXLX',{pd:this.pd2,userCode:this.userCode,userName:this.userName,orgJB:this.juState,orgCode:this.orgCode},
        r =>{
          if(r.success){
