            ...
            <el-col :span="22" class="br pr-20">
              <el-row align="center"   :gutter="2">
                ...
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                  ...
                  <div class="input-input t-flex t-date">
                    <el-input-number  v-model="pd.NL.begin"  :min="0" size="small"></el-input-number>
                    <span class="septum">-</span>
                    <el-input-number v-model="pd.NL.end" :min="0" size="small"></el-input-number>
                 </div>
                </el-col>
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                ...
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                  ...
                  <el-select v-model="pd.ZY" filterable clearable default-first-option  placeholder="请选择"  size="small" class="input-input">
                    <el-option
                      v-for="item in $store.state.zy"
                      :key="item.dm"
                      :label="item.dm+' - '+item.mc"
                      :value="item.dm">
                    </el-option>
                ...
                <el-col  :sm="24" :md="12" :lg="8"  class="input-item">
                    ...
                    <el-select v-model="pd.SLFS" filterable clearable default-first-option placeholder="请选择"  size="small" class="input-input">
                      <el-option label="QG - 自助签注" value="QG"></el-option>
                      <el-option label="WX - 微信" value="WX"></el-option>
                      <el-option label="GT - 前台窗口" value="GT"></el-option>
                    </el-select>
                </el-col>
              </el-row>
             </el-col>
